            ...
            <div class="card mb-5">
                ...
                <div class="col-md-12">
                    <div class="text-right mt-2 mb-1">
                        <a class="btn btn-outline-success" href="/pesanan/cetak_pdf" target="_blank">CETAK PDF</a>
                    </div>
                    <div class=" card ">
                            ...
                            <table id="table_id" class="table table-striped  table-striped table-border m-1 datatable-scroll-y">
                                <thead>
                                    <tr class="text-center">
                                        ...
                                        <th>PENGIRIMAN</th>
                                        <th>NO RESI</th>
                                        <th class="text-center pr-3 pl-3">Opsi</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @foreach($order as $o)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-outline-primary" style="text-decoration:none;" href="/order_detail/{{$o->id}}">
